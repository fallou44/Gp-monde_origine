      ...
      const openModalBtn = document.getElementById('open-cargo-modal');
        ...
        map.on('click', function(e) {
            if (!departMarker) {
                ...
                departMarker = L.marker(e.latlng, { icon: customIcon }).addTo(map);
                document.getElementById('depart').value = e.latlng.lat + ', ' + e.latlng.lng;
                document.getElementById('arrivee').value = '';updateCargos
...
// Fonction pour ajouter un produit à une cargaison
...
// Écouter le changement du type de produit pour afficher ou masquer les champs supplémentaires
...
// Assigner l'événement au bouton d'ajout de produit
