...
document.getElementById('addCargoForm').addEventListener('submit', (event) => {
    ...
    let cargo = null; // Initialisation avec null
...
document.getElementById('addProductForm').addEventListener('submit', (event) => {
    event.preventDefault();
    let product = null; // Initialisation avec null
    ...
    switch (productType) {
        case 'Alimentaire':
            ...
            break;
        case 'Chimique':
            const toxicityLevel = parseFloat(document.getElementById('toxicityLevel').value);
